...
<title>Remove Users - Admin Dashboard</title>
...
<body>
  ...
  <nav class="sidebar">
    ...
    <a href="remove_users.php" class="active">Remove Users</a>
            ...
            <tr>
              ...
              <td>
                <?php if ($user['username'] !== $_SESSION['username']): ?>
                  <a href="remove_users.php?delete_id=<?= $user['id'] ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete user <?= htmlspecialchars($user['username']) ?>?');">Delete</a>
                <?php else: ?>
